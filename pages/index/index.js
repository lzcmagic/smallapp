...
Page({
  ...
  getWeather: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        console.log('image: ' + that.getWeatherUrl(res.data.HeWeather6[0].now.cond_code))
      },
      fail: function (res) {
  ...
  drawChart: function () {
    console.log('data: ' + this.data.forecast[0].date)
    ...
    for (var i = 0; i < tempData.length; i++) {
      ...
      tempDate[i] = "星期"+this.getChineseNumber(new Date(tempData[i].date).getDay());
    }
